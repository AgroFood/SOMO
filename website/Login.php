...
if (isset($_POST['btnLogIn']))
		{
				...
				if (file_exists("user_accounts/un_$userName.txt"))
				{
	...
	<div class="welcome">
		<div class="container">
			<div class="col-md-6 welcome-right">
				...
				<p>Log In To View Products, Place Orders, and more.</p>
				...
				<div class="name na">
					<p>Password:</p>
						<input id="txbPassword" name="txbPassword" type="text" placeholder="Password" required=" " type="" >
				</div>
